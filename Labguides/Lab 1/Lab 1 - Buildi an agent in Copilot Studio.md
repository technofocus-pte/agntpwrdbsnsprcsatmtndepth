**Lab 1: Build an agent in Microsoft Copilot Studio with the new AI
capabilities**
...
9.  Name your agent as [**Real Estate Booking
    Service**](urn:gd:lg:a:send-vm-keys).
...
>
> The agent responds with the "**What is your full name?**" question, as
...
>
> Email address: [**abc@example.com**](urn:gd:lg:a:send-vm-keys) 
>
> Address: [**555 Oak Lane, Denver, CO
> 80203**](urn:gd:lg:a:send-vm-keys) 
>
> Date and Time: [**25/12/2025 10:00 AM**](urn:gd:lg:a:send-vm-keys)
>
> ![](./media/image39.png)
...
> ![](./media/image41.png)
>
> **Summary**: In this lab, you created a [Real Estate Booking
> Service](urn:gd:lg:a:send-vm-keys) agent which helps you to collect
> user’s information. You have used an Adaptive card to summarize
> information collected from the user and to enhance the conversation
> experience.
