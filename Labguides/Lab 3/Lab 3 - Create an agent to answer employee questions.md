...
> ![](./media/image12.png)
>
> This time the response may be appropriate, but it’s also likely to be
> fairly generic.
>
> ![](./media/image13.png)
...
>
> The *Greeting* topic is triggered by an input in which one of the
> following phrases is present:
...
> **When the user asks who to contact about expense claims, tell them to
> send an email to finance@contoso.com**
...
>
> **Note**: When the user asks who to contact about expense claims, tell
> them to send an email to finance@contoso.com
...
> **What’s the expense limit for a hotel stay?**
>
> The response should be based on the information in the knowledge
> source you uploaded, and include a citation reference.
>
> ![](./media/image32.png)
