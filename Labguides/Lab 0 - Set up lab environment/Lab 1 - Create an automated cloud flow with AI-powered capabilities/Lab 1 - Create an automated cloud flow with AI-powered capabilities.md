...
2.  From the left navigation pane, select **+Create** and then select
...
> **Prompt** - When a new response is received to a Microsoft Forms
> survey, create a task, and then post a message on a Teams Channel
>
> ![A screenshot of a computer AI-generated content may be
...
9.  In the **Form Id** field, select **Software Product Feedback** from
    the drop-down menu. Keep the **Response Id** as is in the **Response
    Id** field.
...
>
> ![A screenshot of a task AI-generated content may be
...
> **Channel**: DevChannel
>
> **Message**: Enter +++**A new task has been created based on the
...
> ![A screen shot of a software product AI-generated content may be
...
In this task, we will test the flow to validate that tasks and
...
3.  To trigger the flow, open the form in a new browser window using the
    link saved in Notepad in your browser. Fill out the form. ![A
