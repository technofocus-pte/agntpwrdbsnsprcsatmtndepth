...
> \>**/home+++ (Replacing **\< EnvironmentID \>** with the value fetched
> above)
>
> ![](./media/image4.png)
...
14. In the **Message** box, enter: +++**I'm happy to help you. I just
    need to capture more details.**+++
...
> **Patient Age (Number)**: Select the **Age** variable that you created
> earlier.
>
> **Patient Gender (String):** Select the **Gender** variable that you
> created earlier.
>
> **Primary Symptom (String):** Select the **Symptoms** variable that
> you created earlier.
>
> ![A screenshot of a computer AI-generated content may be
