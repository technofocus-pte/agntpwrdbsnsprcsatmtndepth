...
6.  Select the **Supplier** table, then select **View data,** and explore the data.
...
12. Add a **candyInStock** column with the data type set to **Number**.
    ...
    column will automatically be updated using **candyInStock**.
     ...
     +++Add a candyInStock column to the Inventory table with the whole number data type. The records should be in whole numbers.+++
...
28. Select the **Outcome** listed under the **Start and wait for an Approval** action.
...
35. Click the **Advanced Parameters** drop-down and select the **Quantity** column. 

     ![A screenshot of a computer AI-generated content may be incorrect.](./media/image57.png)

36. Click inside the **Quantity** field and select the **Function** icon.

     ![](./media/image58.png)

37. Enter the below function (you type in your app) and collapse the action.

     **Note:** The below function does not work for you as your column
     schema name will be different. Go to the table > column, and copy the schema name.
...
39. Rename the flow - **Candy Restock Flow**.
     ...
     ![A screenshot of a search box AI-generated content may be incorrect.](./media/image61.png)

40. Save the flow by selecting the **Save** button in the upper-right corner of the screen.
...
4.  Enter the +++Quantity++ value **less than the reorder
    points** and **commit** changes. Enter +++Inventory 3+++ as an **Inventory**.
