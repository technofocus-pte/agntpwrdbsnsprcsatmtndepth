...
> ![A white background with blue and purple text AI-generated content
...
20. The list after adding all the columns looks like the image below.
...
> **Note:** Refresh the page if you don’t see your site under the
> drop-down menu.
>
> ![A screenshot of a computer AI-generated content may be
...
> ![](./media/image44.png)
>
> **Note:** This action sends the approval request to the email address
> in the **Assigned To** box.
...
> Follow these steps to send an email if the vacation request is
> approved:
...
> Approver Comments – Select **Responses Comments** from dynamic
> content.
>
> ![](./media/image52.png)
...
> **Note: Site Address**, **List Name**, **Id**, and **Title** are
> required.
>
> ![](./media/image56.png)
...
> ![](./media/image67.png)
>
> After you save this request, the flow triggers, and then, creates a
> request in the approvals center.
...
> ![](./media/image78.png)
>
> **Note:** The cancel feature is supported on the **Create an approval
> (v2)** action.
>
